...
caliberEditor allows users to customize their Slash Commands menu by including
...
than what caliberEditor is preconfigured to support, you need to pass those
extensions via the `extensions` prop of caliberEditor so that editor can recognise
