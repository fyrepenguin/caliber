...
class EmojiSuggestionMenu extends React.Component {
  ...
  render() {
    return (
      <div className="caliber-editor-emoji-suggestion">
          ...
          (this.state.emojiSuggestions.length > 0 ? (
            this.state.emojiSuggestions.map((emoji, index) => (
              <div
                ...
                className={classnames("caliber-editor-emoji-suggestion__item", {
                  "caliber-editor-emoji-suggestion__item--selected":
                    index === this.state.selectedIndex,
                })}
                data-cy={`caliber-editor-emoji-suggestion-${emoji.id}`}
              >
