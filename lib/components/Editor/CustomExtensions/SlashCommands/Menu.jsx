...
class Menu extends React.Component {
  ...
  render() {
    ...
    return (
      <div ref={this.menuRef} className="caliber-editor-slash-commands__wrapper">
...
const MenuItem = forwardRef(
  ({ item, selectedIndex, index, selectItem, onHover }, ref) => {
    ...
    return (
      <div
        className={classnames("caliber-editor-slash-commands__item", {
          active: index === selectedIndex,
        })}
        onClick={selectItem}
        ref={ref}
        data-cy={`caliber-editor-command-list-item-${index}`}
        onMouseEnter={onHover}
      >
        {Icon && <Icon size={20} />}
        <div className="caliber-editor-slash-commands__item-content">
          <h5>{item.title}</h5>
